...
Dazu wird ein weiteres Headerfeld im Mail-Header (_X-KIM-Dienstkennung_) erzeugt und mit Werten befüllt welche bei Bedarf den Inhalt der Mail beschreibt. Die verwendeten E-Mail Kategorien müssen von allen KOM-LE-Fachdiensten einheitlich verwendet werden und Anbieter übergreifend eine Auswertung zu ermöglichen.
