...
Für KOM-LE 1.5 ist es notwenig das Clientmodul um folgendes anzupassen:
...
Die folgende Abbildung verdeutlicht die optionale Intergration in das PVS:
...
Mit diesem Wert prüft der Client-Modul die Einhaltung der maximalen Mail Größe (die vom FD Anbieter definiert wird) für zu sendende Mails.
...
HTTP-Status Codes: + 
200: OK - Maximale Mail Größe wird in Bytes zurückgegeen +
...
HTTP-Status Codes: + 
200: OK - Die Anfrage wurde erfolgreich +
400: Bad Request - Das neue Passwot entspricht nicht den Regeln +
401: Unauthorized - Nutzername / Passwort +
